  ...
  return (
    <div className="block md:grid grid-cols-5 gap-[5%] justify-center items-center m-[5%]">
      ...
      <div className="col-span-2 p-4 flex flex-col justify-between items-center">
        <p className="cursive text-center m-[4%] text-5xl md:text-4xl xl:text-8xl">Explore Our Delicious cursive</p>
        <p className=' xl:text-2xl text-center my-5 md:my-5 text-md'>"Laughter is brightest in the place where the food is." – Irish Proverb</p>
